...
exports.MONGODB = {
  uri: `mongodb://${argv.db_username || 'DB_username'}:${
    argv.db_password || 'DB_password'
  }@127.0.0.1:${argv.dbport || '27017'}/blogNode`,
...
exports.AKISMET = {
  ...
  blog:
    argv.akismet_blog ||
    'your akismet blog site, like: http://biaochenxuying.cn/main.html',
};
